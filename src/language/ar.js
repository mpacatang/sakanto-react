export const arabic = {
  ...
  "Register as seller and open shop in SaKanto to start your business":
    "سجل كبائع ومتجر مفتوح في SaKanto لبدء عملك",
  ...
  eBusiness: "Ebusiness",
  Solution: "حل",
  "SaKanto is a Laravel and Flutter Framework-based multi-vendor food, grocery, eCommerce, parcel, and pharmacy delivery system. It has six modules to cover all your business functionality.":
    "SaKanto عبارة عن نظام توصيل متعدد البائعين ، والبقالة ، والتجارة الإلكترونية ، والتجارة الإلكترونية ، والتجارة الإلكترونية ، والطرز ، ونظام توصيل الصيدلة ، SaKanto عبارة عن نظام توصيل الصيدلة ، وتجارة الإلكترون ، والتجارة الإلكترونية ، والطرد ، ونظام توصيل الصيدلة. لديها ست وحدات لتغطية جميع وظائف عملك.",
